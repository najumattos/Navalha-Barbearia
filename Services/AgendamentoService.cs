...
public class AgendamentoService(
    ...
    IAgendamentoValidacaoService agendamentoValidacaoService) : IAgendamentoService
{
    ...
    public List<AgendamentoModel> ObterPorBarbeiroId(int barbeiroId, TipoAcessoEnum tipoAcessoSolicitante)
    {
        ...
        var agendamentos = tipoAcessoSolicitante == TipoAcessoEnum.Administrador
            ? agendamentoRepository.ObterTodos()
            : agendamentoRepository.ObterPorBarbeiroId(barbeiroId);
    ...
    public List<AgendamentoModel> ObterPorCpfCliente(string cpf, TipoAcessoEnum tipoAcessoSolicitante)
    {
        ...
        var agendamentos = agendamentoRepository.ObterPorCpfCliente(cpf);
    ...
    public AgendamentoModel? ObterPorId(int idAgendamento, int barbeiroIdSolicitante, TipoAcessoEnum tipoAcessoSolicitante)
    {
        ...
        var agendamento = agendamentoRepository.ObterPorId(idAgendamento);
    ...
    public AgendamentoModel Criar(AgendamentoModel agendamento)
    {
        ...
        var slotValidado = agendamentoValidacaoService.ValidarCriacaoComSlotLivre(agendamento);
        ...
        var cliente = clienteRepository.ObterPorCpf(cpfCliente)
            ?? throw new KeyNotFoundException($"Cliente com CPF {cpfCliente} nao encontrado.");

        var barbeiro = barbeiroRepository.ObterPorId(barbeiroId.Value)
        ...
        else
        {
            ...
            var procedimentoCatalogo = procedimentoRepository.ObterPorId((int)agendamento.Procedimento)
        ...
        var agendamentoCriado = agendamentoRepository.Adicionar(agendamento);
        slotHorarioService.OcuparSlot(slotValidado.Id);
    ...
    public AgendamentoModel AtualizarDoFuncionario(int idAgendamento, int barbeiroIdSolicitante, AgendamentoModel agendamento, TipoAcessoEnum tipoAcessoSolicitante)
    {
        ...
        var agendamentoExistente = agendamentoRepository.ObterPorId(idAgendamento)
        ...
        return agendamentoRepository.Atualizar(agendamentoExistente);
    }
    ...
    public void Excluir(int idAgendamento, int barbeiroIdSolicitante, TipoAcessoEnum tipoAcessoSolicitante)
    {
        ...
        agendamentoRepository.Excluir(idAgendamento);
    }
