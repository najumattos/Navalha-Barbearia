...
public class BarbeiroService(IBarbeiroRepository barbeiroRepository, IProcedimentoRepository procedimentoRepository) : IBarbeiroService
{
    public List<BarbeiroModel> ObterTodos()
    {
        ...
        var barbeiros = barbeiroRepository.ObterTodos();
    ...
    {
        var barbeiro = barbeiroRepository.ObterPorId(id);
        if (barbeiro is null)
        {
            return null;
        }
    ...
    public BarbeiroModel Criar(BarbeiroModel barbeiro)
    {
        ...
        SincronizarEstruturasDeProcedimento(barbeiro);
        return barbeiroRepository.Adicionar(barbeiro);
    }
    ...
    public BarbeiroModel Atualizar(BarbeiroModel barbeiro)
    {
        ...
        return barbeiroRepository.Atualizar(barbeiro);
    }

    public void Excluir(int id)
    {
        barbeiroRepository.Excluir(id);
    }
    ...
    public ProcedimentoModel AdicionarProcedimentoAoBarbeiro(int barbeiroId, int procedimentoId, TipoAcessoEnum tipoAcessoSolicitante)
    {
        ...
        var procedimentoCatalogo = procedimentoRepository.ObterPorId(procedimentoId)
    ...
    {
        return barbeiroRepository.ObterPorId(barbeiroId)
    ...
    private void SincronizarEstruturasDeProcedimento(BarbeiroModel barbeiro)
    {
        ...
        {
            var procedimentoCatalogo = procedimentoRepository.ObterPorId(relacao.ProcedimentoId);
