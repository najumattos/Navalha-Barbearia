...
public class SlotHorarioService(IAgendamentoRepository agendamentoRepository) : ISlotHorarioService
{
    ...
    {
        var agendamentosDoDia = agendamentoRepository.ObterPorBarbeiroId(barbeiroId)
